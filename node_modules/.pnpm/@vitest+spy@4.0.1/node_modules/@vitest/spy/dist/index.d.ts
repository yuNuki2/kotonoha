...
interface Mock<T extends Procedure | Constructable = Procedure> extends MockInstance<T> {
...
declare function createMockInstance(options?: MockInstanceOption): Mock;
...
>(object: T, key: M): Required<T>[M] extends {
	new (...args: infer A): infer R;
} ? Mock<{
	new (...args: A): R;
}> : Required<T>[M] extends Procedure ? Mock<Required<T>[M]> : never;
...
export type { MaybeMocked, MaybeMockedConstructor, MaybeMockedDeep, MaybePartiallyMocked, MaybePartiallyMockedDeep, Mock, MockContext, MockInstance, MockInstanceOption, MockParameters, MockProcedureContext, MockResult, MockResultIncomplete, MockResultReturn, MockResultThrow, MockReturnType, MockSettledResult, MockSettledResultFulfilled, MockSettledResultIncomplete, MockSettledResultRejected, Mocked, MockedClass, MockedFunction, MockedFunctionDeep, MockedObject, MockedObjectDeep, PartialMock, PartiallyMockedFunction, PartiallyMockedFunctionDeep };
